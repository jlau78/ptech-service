...
CREATE SEQUENCE SEQ_PRICE_INFO START 1010;
ALTER TABLE PRICE_INFO ALTER COLUMN ID SET DEFAULT NEXTVAL('SEQ_PRICE_INFO');

CREATE SEQUENCE SEQ_MEDIA START 1020;
ALTER TABLE MEDIA ALTER COLUMN ID SET DEFAULT NEXTVAL('SEQ_MEDIA');

CREATE SEQUENCE SEQ_PRODUCT START 1050;
ALTER TABLE MEDIA ALTER COLUMN ID SET DEFAULT NEXTVAL('SEQ_PRODUCT');
